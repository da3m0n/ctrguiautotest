...
def main():
    ...
    testLog = TestLog()
    about.run_system_about(Utils.create_driver(sys.argv[2]), testLog)
...
class SystemAbout(object):
    ...
    def run_system_about(self, driver, testLog):
        gui_lib = Utils()

        self.login_manager.login(driver)
        testLog.start('System About')
        ...
        testHelper.assertTrue(len(licenses.text) == 0, 'Expected SW Version to be > 0',
